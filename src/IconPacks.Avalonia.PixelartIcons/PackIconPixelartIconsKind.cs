...
namespace IconPacks.Avalonia.PixelartIcons
{
    ...
    public enum PackIconPixelartIconsKind
    {
        ...
        [Description("arrow-down-box")]
        ArrowDownBox,

        [Description("arrow-left")]
        ArrowLeft,

        [Description("arrow-left-box")]
        ArrowLeftBox,

        [Description("arrow-right")]
        ArrowRight,

        [Description("arrow-right-box")]
        ArrowRightBox,
        ...
        [Description("arrow-up-box")]
        ArrowUpBox,

        [Description("article")]
        Article,

        [Description("article-multiple")]
        ArticleMultiple,
        ...
        [Description("briefcase-account")]
        BriefcaseAccount,

        [Description("briefcase-check")]
        BriefcaseCheck,

        [Description("briefcase-delete")]
        BriefcaseDelete,
        ...
        [Description("briefcase-plus")]
        BriefcasePlus,

        [Description("briefcase-search")]
        BriefcaseSearch,

        [Description("briefcase-search-1")]
        BriefcaseSearch1,
        ...
        [Description("building-skyscraper")]
        BuildingSkyscraper,
        ...
        [Description("calendar-arrow-left")]
        CalendarArrowLeft,

        [Description("calendar-arrow-right")]
        CalendarArrowRight,

        [Description("calendar-check")]
        CalendarCheck,

        [Description("calendar-export")]
        CalendarExport,

        [Description("calendar-grid")]
        CalendarGrid,

        [Description("calendar-import")]
        CalendarImport,
        ...
        [Description("calendar-multiple")]
        CalendarMultiple,

        [Description("calendar-multiple-check")]
        ...
        [Description("calendar-remove")]
        CalendarRemove,

        [Description("calendar-search")]
        CalendarSearch,

        [Description("calendar-sort-ascending")]
        CalendarSortAscending,

        [Description("calendar-sort-descending")]
        ...
        [Description("calendar-week-begin")]
        CalendarWeekBegin,

        [Description("calendar-weekend")]
        CalendarWeekend,

        [Description("camera")]
        Camera,

        [Description("camera-add")]
        CameraAdd,
        ...
        [Description("cellular-signal-0")]
        CellularSignal0,

        [Description("cellular-signal-1")]
        CellularSignal1,

        [Description("cellular-signal-2")]
        CellularSignal2,

        [Description("cellular-signal-3")]
        CellularSignal3,

        [Description("cellular-signal-off")]
        CellularSignalOff,
        ...
        [Description("chart-minus")]
        ChartMinus,

        [Description("chart-multiple")]
        ChartMultiple,
        ...
        [Description("chevrons-horizontal")]
        ChevronsHorizontal,

        [Description("chevrons-vertical")]
        ChevronsVertical,
        ...
        [Description("credit-card-minus")]
        CreditCardMinus,

        [Description("credit-card-multiple")]
        CreditCardMultiple,

        [Description("credit-card-plus")]
        CreditCardPlus,

        [Description("credit-card-settings")]
        CreditCardSettings,

        [Description("credit-card-wireless")]
        CreditCardWireless,
        ...
        [Description("device-tv-smart")]
        DeviceTvSmart,

        [Description("device-vibrate")]
        DeviceVibrate,
        ...
        [Description("drop-full")]
        DropFull,

        [Description("drop-half")]
        DropHalf,

        [Description("duplicate")]
        Duplicate,

        [Description("duplicate-alt")]
        DuplicateAlt,
        ...
        [Description("frame-check")]
        FrameCheck,

        [Description("frame-delete")]
        FrameDelete,

        [Description("frame-minus")]
        FrameMinus,
        ...
        [Description("human-handsdown")]
        HumanHandsdown,

        [Description("human-handsup")]
        HumanHandsup,

        [Description("human-height")]
        HumanHeight,

        [Description("human-height-alt")]
        HumanHeightAlt,

        [Description("human-run")]
        HumanRun,

        [Description("image")]
        Image,

        [Description("image-arrow-right")]
        ImageArrowRight,
        ...
        [Description("label-alt-multiple")]
        LabelAltMultiple,
        ...
        [Description("layout-align-bottom")]
        LayoutAlignBottom,

        [Description("layout-align-left")]
        LayoutAlignLeft,

        [Description("layout-align-right")]
        LayoutAlignRight,

        [Description("layout-align-top")]
        LayoutAlignTop,

        [Description("layout-columns")]
        LayoutColumns,

        [Description("layout-distribute-horizontal")]
        LayoutDistributeHorizontal,

        [Description("layout-distribute-vertical")]
        ...
        [Description("layout-sidebar-left")]
        LayoutSidebarLeft,

        [Description("layout-sidebar-right")]
        LayoutSidebarRight,

        [Description("lightbulb")]
        Lightbulb,

        [Description("lightbulb-2")]
        Lightbulb2,
        ...
        [Description("mail-flash")]
        MailFlash,

        [Description("mail-multiple")]
        MailMultiple,

        [Description("mail-off")]
        MailOff,

        [Description("mail-unread")]
        MailUnread,
        ...
        [Description("message-clock")]
        MessageClock,

        [Description("message-delete")]
        MessageDelete,

        [Description("message-flash")]
        MessageFlash,
        ...
        [Description("more-horizontal")]
        MoreHorizontal,

        [Description("more-vertical")]
        MoreVertical,
        ...
        [Description("note-multiple")]
        NoteMultiple,

        [Description("note-plus")]
        NotePlus,
        ...
        [Description("notes-multiple")]
        NotesMultiple,

        [Description("notes-plus")]
        NotesPlus,

        [Description("notification")]
        Notification,

        [Description("notification-off")]
        NotificationOff,
        ...
        [Description("remove-box-multiple")]
        RemoveBoxMultiple,
        ...
        [Description("section-minus")]
        SectionMinus,

        [Description("section-plus")]
        SectionPlus,
        ...
        [Description("sliders-2")]
        Sliders2,

        [Description("sort")]
        Sort,

        [Description("sort-alphabetic")]
        SortAlphabetic,

        [Description("sort-numeric")]
        SortNumeric,
        ...
        [Description("speed-medium")]
        SpeedMedium,

        [Description("speed-slow")]
        SpeedSlow,
        ...
        [Description("view-col")]
        ViewCol,

        [Description("view-list")]
        ViewList,

        [Description("viewport-narrow")]
        ViewportNarrow,
        ...
        [Description("volume-minus")]
        VolumeMinus,

        [Description("volume-plus")]
        VolumePlus,

        [Description("volume-vibrate")]
        VolumeVibrate,
