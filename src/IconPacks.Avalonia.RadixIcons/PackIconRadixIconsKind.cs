...
namespace IconPacks.Avalonia.RadixIcons
{
    ...
    public enum PackIconRadixIconsKind
    {
        ...
        [Description("align-center-vertically")]
        ...
        [Description("arrow-bottom-left")]
        ArrowBottomLeft,

        [Description("arrow-bottom-right")]
        ArrowBottomRight,
        ...
        [Description("arrow-top-left")]
        ArrowTopLeft,

        [Description("arrow-top-right")]
        ArrowTopRight,
        ...
        [Description("card-stack-minus")]
        CardStackMinus,

        [Description("card-stack-plus")]
        CardStackPlus,
        ...
        [Description("corner-bottom-left")]
        CornerBottomLeft,

        [Description("corner-bottom-right")]
        CornerBottomRight,

        [Description("corners")]
        Corners,

        [Description("corner-top-left")]
        CornerTopLeft,

        [Description("corner-top-right")]
        CornerTopRight,

        [Description("countdown-timer")]
        CountdownTimer,

        [Description("counter-clockwise-clock")]
        ...
        [Description("cross-circled")]
        CrossCircled,

        [Description("crosshair-1")]
        Crosshair1,

        [Description("crosshair-2")]
        Crosshair2,
        ...
        [Description("divider-horizontal")]
        DividerHorizontal,
        ...
        [Description("double-arrow-down")]
        DoubleArrowDown,

        [Description("double-arrow-left")]
        DoubleArrowLeft,

        [Description("double-arrow-right")]
        DoubleArrowRight,

        [Description("double-arrow-up")]
        DoubleArrowUp,

        [Description("download")]
        Download,

        [Description("drag-handle-dots-1")]
        DragHandleDots1,

        [Description("drag-handle-dots-2")]
        DragHandleDots2,

        [Description("drag-handle-horizontal")]
        DragHandleHorizontal,

        [Description("drag-handle-vertical")]
        DragHandleVertical,

        [Description("drawing-pin")]
        DrawingPin,

        [Description("drawing-pin-filled")]
        DrawingPinFilled,
        ...
        [Description("hobby-knife")]
        HobbyKnife,

        [Description("home")]
        Home,

        [Description("iconjar-logo")]
        IconjarLogo,
        ...
        [Description("letter-case-capitalize")]
        LetterCaseCapitalize,

        [Description("letter-case-lowercase")]
        LetterCaseLowercase,

        [Description("letter-case-toggle")]
        LetterCaseToggle,

        [Description("letter-case-uppercase")]
        LetterCaseUppercase,
        ...
        [Description("link-break-1")]
        LinkBreak1,

        [Description("link-break-2")]
        LinkBreak2,

        [Description("linkedin-logo")]
        LinkedinLogo,

        [Description("link-none-1")]
        LinkNone1,

        [Description("link-none-2")]
        LinkNone2,
        ...
        [Description("lock-open-1")]
        LockOpen1,

        [Description("lock-open-2")]
        LockOpen2,
        ...
        [Description("minus-circled")]
        MinusCircled,

        [Description("mix")]
        Mix,

        [Description("mixer-horizontal")]
        MixerHorizontal,
        ...
        [Description("plus-circled")]
        PlusCircled,

        [Description("question-mark")]
        QuestionMark,

        [Description("question-mark-circled")]
        QuestionMarkCircled,
        ...
        [Description("sewing-pin")]
        SewingPin,

        [Description("sewing-pin-filled")]
        SewingPinFilled,
        ...
        [Description("space-between-horizontally")]
        SpaceBetweenHorizontally,

        [Description("space-between-vertically")]
        ...
        [Description("speaker-loud")]
        SpeakerLoud,

        [Description("speaker-moderate")]
        SpeakerModerate,

        [Description("speaker-off")]
        SpeakerOff,

        [Description("speaker-quiet")]
        SpeakerQuiet,
        ...
        [Description("text-align-middle")]
        TextAlignMiddle,

        [Description("text-align-right")]
        TextAlignRight,

        [Description("text-align-top")]
        TextAlignTop,

        [Description("text-none")]
        TextNone,

        [Description("thick-arrow-down")]
        ThickArrowDown,
        ...
        [Description("track-next")]
        TrackNext,

        [Description("track-previous")]
        TrackPrevious,

        [Description("transform")]
        Transform,

        [Description("transparency-grid")]
        TransparencyGrid,
        ...
        [Description("view-horizontal")]
        ViewHorizontal,

        [Description("view-none")]
        ViewNone,

        [Description("view-vertical")]
        ViewVertical,
