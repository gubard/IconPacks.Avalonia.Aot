...
namespace IconPacks.Avalonia.Zondicons
{
    ...
    public enum PackIconZondiconsKind
    {
        ...
        [Description("arrow-outline-down")]
        ArrowOutlineDown,

        [Description("arrow-outline-left")]
        ArrowOutlineLeft,

        [Description("arrow-outline-right")]
        ArrowOutlineRight,

        [Description("arrow-outline-up")]
        ArrowOutlineUp,

        [Description("arrow-right")]
        ArrowRight,

        [Description("arrow-thick-down")]
        ArrowThickDown,
        ...
        [Description("arrow-thick-up")]
        ArrowThickUp,

        [Description("arrow-thin-down")]
        ArrowThinDown,

        [Description("arrow-thin-left")]
        ArrowThinLeft,

        [Description("arrow-thin-right")]
        ArrowThinRight,

        [Description("arrow-thin-up")]
        ArrowThinUp,
        ...
        [Description("bookmark copy 2")]
        BookmarkCopy2,

        [Description("bookmark copy 3")]
        BookmarkCopy3,

        [Description("bookmark-outline")]
        BookmarkOutline,

        [Description("bookmark-outline-add")]
        BookmarkOutlineAdd,
        ...
        [Description("browser-window-new")]
        BrowserWindowNew,

        [Description("browser-window-open")]
        BrowserWindowOpen,
        ...
        [Description("chat-bubble-dots")]
        ChatBubbleDots,

        [Description("checkmark")]
        Checkmark,

        [Description("checkmark-outline")]
        CheckmarkOutline,

        [Description("cheveron-down")]
        CheveronDown,

        [Description("cheveron-left")]
        CheveronLeft,

        [Description("cheveron-outline-down")]
        CheveronOutlineDown,

        [Description("cheveron-outline-left")]
        CheveronOutlineLeft,

        [Description("cheveron-outline-right")]
        CheveronOutlineRight,

        [Description("cheveron-outline-up")]
        CheveronOutlineUp,

        [Description("cheveron-right")]
        CheveronRight,

        [Description("cheveron-up")]
        CheveronUp,
        ...
        [Description("dots-horizontal-double")]
        DotsHorizontalDouble,

        [Description("dots-horizontal-triple")]
        ...
        [Description("exclamation-outline")]
        ExclamationOutline,

        [Description("exclamation-solid")]
        ExclamationSolid,
        ...
        [Description("folder-outline-add")]
        FolderOutlineAdd,

        [Description("format-bold")]
        FormatBold,

        [Description("format-font-size")]
        FormatFontSize,

        [Description("format-italic")]
        FormatItalic,

        [Description("format-text-size")]
        FormatTextSize,
        ...
        [Description("information-outline")]
        InformationOutline,

        [Description("information-solid")]
        InformationSolid,
        ...
        [Description("location-food")]
        LocationFood,

        [Description("location-gas-station")]
        LocationGasStation,

        [Description("location-hotel")]
        LocationHotel,

        [Description("location-marina")]
        LocationMarina,

        [Description("location-park")]
        LocationPark,

        [Description("location-restroom")]
        LocationRestroom,

        [Description("location-shopping")]
        LocationShopping,
        ...
        [Description("minus-outline")]
        MinusOutline,

        [Description("minus-solid")]
        MinusSolid,

        [Description("mobile-devices")]
        MobileDevices,

        [Description("mood-happy-outline")]
        MoodHappyOutline,

        [Description("mood-happy-solid")]
        MoodHappySolid,

        [Description("mood-neutral-outline")]
        MoodNeutralOutline,

        [Description("mood-neutral-solid")]
        MoodNeutralSolid,

        [Description("mood-sad-outline")]
        MoodSadOutline,

        [Description("mood-sad-solid")]
        MoodSadSolid,
        ...
        [Description("subdirectory-left")]
        SubdirectoryLeft,

        [Description("subdirectory-right")]
        SubdirectoryRight,
        ...
        [Description("user-solid-circle")]
        UserSolidCircle,

        [Description("user-solid-square")]
        UserSolidSquare,
